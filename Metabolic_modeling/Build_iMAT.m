function [iMAT_model]=Build_iMAT(model, met_DATA, met_DATA_exp, num_sample)
...
category={'S_0','M_0','T_0','MT_0','S_230','M_230','T_230','MT_230'};
exp=mapGeneToRxn(model,met_DATA(:,1),double(met_DATA_exp(:,i)),parsedGPR,corrRxn);
exp(find(exp==0))=-1;
...
str=['iMAT_new_models_',category{i},'=','iMAT_model']; 
